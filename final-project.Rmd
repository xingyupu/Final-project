...
Firstly, I'll introduce and analyse survey data and census data. Then, from data I analyzed before, I can construct MRP models and interpret it. After obtaining MRP models, I can compare the estimated results from models with real results and then check if there are any differences. Lastly, I'll discuss weaknesses of my process.
...
General Social Survey provide people with a clear and unbiased view about what Americans think and feel about issues such as national spending priorities. It collects data on contemporary American society in order to monitor and explain trends in opinions, attitudes and behaviors[4]. In my selected census data, the target population concludes 4 more different human races and education level from 0 to 10. 
